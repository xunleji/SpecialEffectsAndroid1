...
import com.example.specialeffectsandroid.souhutab.ToolUntil;
...
public class AVLoadingIndicatorView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		int width = measureDimension(
				ToolUntil.dip2px(getContext(), DEFAULT_SIZE), widthMeasureSpec);
		int height = measureDimension(
				ToolUntil.dip2px(getContext(), DEFAULT_SIZE), heightMeasureSpec);

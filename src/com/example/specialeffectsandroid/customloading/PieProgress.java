...
public class PieProgress extends View {
	...
	public PieProgress(Context context, AttributeSet attrs) {
		...
		mPadding = scale * PADDING
				+ r.getDimension(R.dimen.actionbar_vertival_padding);
	...
	private void parseAttributes(TypedArray a) {
		mColorForeground = a.getColor(R.styleable.PieProgress_foregroundColor,
				mColorForeground);
		mColorBackground = a.getColor(R.styleable.PieProgress_backgroundColor,
				mColorBackground);
		// Recycle
		a.recycle();
	}

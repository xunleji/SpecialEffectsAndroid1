	...
	protected void onDraw(Canvas canvas) {
		...
		case SHAPE_TRIANGLE:
			...
			if (mIsLoading) {
				...
				int color = (Integer) mArgbEvaluator.evaluate(mAnimPercent,
						mTriangleColor, mCircleColor);
				...
				float controlX = mControlX
						- relativeXFromView(mAnimPercent * mTriangle2Circle)
						* genhao3;
				float controlY = mControlY
						- relativeYFromView(mAnimPercent * mTriangle2Circle);
				...
				path.quadTo(relativeXFromView(0.5f), relativeYFromView(0.75f
						+ 2 * mAnimPercent * mTriangle2Circle),
						relativeXFromView(0.5f - genhao3 / 4),
						relativeYFromView(0.75f));

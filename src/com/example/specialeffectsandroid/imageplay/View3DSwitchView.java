 ...
 */
public class View3DSwitchView extends ViewGroup {
	/**
	 * 图片左右两边的空白间距
	 */
	...
	public View3DSwitchView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		if (changed || forceToRelayout) {
			...
			if (mCurrentImage >= 0 && mCurrentImage < mCount) {
				...
				// View childView = (View) getChildAt(items[i]);

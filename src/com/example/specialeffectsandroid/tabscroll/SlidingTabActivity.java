...
public class SlidingTabActivity extends FragmentActivity implements
	...
	private final String[] titles = { "热门", "iOS", "Android", "前端", "后端", "设计",
			"工具资源" };
	...
	public void onTabSelect(int position) {
		Toast.makeText(this, "onTabSelect&position--->" + position,
				Toast.LENGTH_SHORT).show();
	}

	@Override
	public void onTabReselect(int position) {
		Toast.makeText(this, "onTabReselect&position--->" + position,
				Toast.LENGTH_SHORT).show();
	}
